...
{
    public class CreatingBankAccount
    {
        ...
        public CreatingBankAccount(IConfiguration configuration)
        {
        ...
        public void CreateBankAccount()
        {
            ...
            catch (Exception e) { throw new ArgumentException(e.Message, e.StackTrace); }
